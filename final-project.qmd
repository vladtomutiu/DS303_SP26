...
::: r-fit-text
Mixed effects models can account for modeling specific clubs and positions as a random effect, allowing us to see the variability between different clubs and position through random effects.
:::
