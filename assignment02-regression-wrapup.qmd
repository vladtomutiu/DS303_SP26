...
the coefficient for body_mass_g is 0.01305, indicating that for every one unit increase in body mass, flipper length increases by approximately 0.01305 grams and it is statistically significant. While holding bill_length_mm constant.

the coefficient for bill_length_mm is 0.5492, indicating that for every one unit increase in body mass, flipper length increases by approximately 0.5492 millimeters and it is statistically significant. While holding body_mass_g constant.
...
-   Is it possible to compare the models from Questions 3 and 5 using the same method? Why or why not?
    ...
    -   **Answer:**
        ...
        It is possible to compare the models from Question 3 and 5. As long as the models are hierarchical and nested, anova is able to compare the models and help us determine which model is better.\
...
-   What is your interpretation of this model output? Address all coefficients.
    ...
    -   For the change from island Biscoe to island Dream, the flipper length of the penguins decrease by 16.634 millimeters and is statistically significant, holding island Torgersen constant.

    -   For the change from island Biscoe to island Torgersen, the flipper length of the penguins decrease by 18.5105 millimeters and is statistically significant, holding island Dream constant.
...
-   What is your interpretation of this new model output? Address all coefficients.
    ...
    -   For the change from island Dream to island Biscoe, the flipper length of the penguins increases by 16.634 millimeters and is statistically significant, holding island Torgersen constant.
    -   For the change from island Dream to island Torgersen, the flipper length of the penguins decrease by 1.877 millimeters and it is not statistically significant, holding island Biscoe constant.
...
**Answer:**\
The intercept is -7.65801 and this is the log-odds of being a female when flipper length is zero. The coefficient flipper_length_mm represents the change in the log-odds of being a male for a one-unit increase in flipper length. Since the coefficient is positive, it suggests that **as flipper length increases, the log-odds of being a male also increases**.
